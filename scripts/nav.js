    ...
    <div class="min-header-bar">
        <div class="wrap">
            ...
            <div class="information">
                ...
                <div class="group">
                    <a class="link" href="./signup.html">Đăng Ký</a>
                </div>
            </div>
        </div>
    </div>
    <nav>
        <div class="wrap">
            ...
            <ul>
                ...
                <li class="${location.pathname == "/events.html" ? "active" : ""}""><a href="/events.html">Sự Kiện</a></li>
                ...
                <li class="${location.pathname == "/contact.html" ? "active" : ""}""><a href="/contact.html">Liên Hệ</a></li>
                <li class="${location.pathname == "/social.html" ? "active" : ""}""><a href="/social.html">Hỏi Đáp</a></li>
            </ul>
        </div>
        </div>
    </nav>
